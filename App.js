  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.mainView}>
        <TextInput keyboardType={"number-pad"} value={originalPrice} onChangeText={(orgPrice) => setOriginalPrice(orgPrice)} style={styles.textFields} placeholder={"Enter Original Price"} />
        <View style={{ paddingTop: 10 }} />
        <TextInput keyboardType={"number-pad"} value={discountPrc} onChangeText={(discountPercentage) => setDicountPrc(discountPercentage)} style={styles.textFields} placeholder={" Enter Discount %"} />
        <View style={{ paddingTop: 20 }} />
        <TouchableOpacity onPress={() => calcDiscount()} style={styles.calcBtn}>
